...
- Tool (Teal / Google Sheet / Module 4 `.xlsx`): __________
- Link or file name: __________
- I can open it in under 10 seconds: [ ] yes

## 2) Required columns (check when the column exists)
...
- [ ] One practice row filled  
- [ ] Answer in Progress app = this tracker link or sheet name  
