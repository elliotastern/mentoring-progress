...
export const STAGES = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "prep_system",
        label: "Module 5 prep script + prep checklist filled (exit worksheet)",
        sheet: ws("module-exit-5"),
        doc: module5("module-5-prepare.md"),
      },
      {
        id: "m5_mock",
        label: "Asked for peer mock interviews in #5-interview-prep (or booked 2 peers)",
        sheet: ws("module-exit-5"),
      },
      {
        id: "m5_habit",
        label: "Interview prep habit started (45 mins daily)",
        sheet: ws("module-exit-5"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "m5_pre_post",
        label: "Pre-Interview + Post-Interview checklists ready to run (Module 5)",
        sheet: ws("module-exit-5"),
      },
      {
        id: "m5_exit",
        label: "Module 5 exit worksheet complete",
        sheet: ws("module-exit-5"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "m6_expected",
        label: "Expected-salary script practiced (Module 6)",
        sheet: ws("module-exit-6"),
      },
      {
        id: "m6_exit",
        label: "Module 6 exit worksheet complete (lessons + comp worksheet)",
        sheet: ws("module-exit-6"),
      },
    ],
  },
